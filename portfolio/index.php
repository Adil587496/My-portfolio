...
<meta name="keywords" content="Adil El ghazzali, Flask Python projects, tensorFlow, Android, 
...
<div class="switch-lang"> 
  ...
  <div class="lang-dropdown">
    <li class="selecting-lang current-lang"><img class="lang-flag" src="https://cdn2.iconfinder.com/data/icons/world-flag-icons/128/Flag_of_Spain.png"/>
      <a class="lang-text" href="index.php?lang=es">Español</a>
    </li>
    ...
    <li class="selecting-lang"><img class="lang-flag" src="https://cdn2.iconfinder.com/data/icons/world-flag-icons/128/Flag_of_Sweden.png"/>
      <a class="lang-text" href="index.php?lang=sw">Sweden </a>
		</li>
...
<!-- end lang -->
		<header>
				...
				<nav class="cd-stretchy-nav">
				 ...
				 <ul>
					 <li><a href="index.html" class="active"><span><?php echo $lang['hoo'] ?></span></a></li>
				...
				<div class="col-lg-8">
					<form name="contactform" id="contactform" method="post" action="mail.php" onsubmit="return(validate());" novalidate="novalidate">
						<div class="row">
							...
							<button  name="submit" type="submit" class="btn btn-default"><?php echo $lang['sub'] ?></button>
						</div>
					</form>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-3 copy-right p-0 text-lg-right">
				...
				<ul class="social_section_1info">
					...
					<li class="mb-2 twitter"><a href="#"target="_blank"><span class="fab fa-twitter"></span></a></li>
					...
					<li class="bitbucket"><a href="https://bitbucket.org/%7B6d09b9e7-55a1-440f-b49a-d6d701c13492%7D/"target="_blank"><span class="fab fa-bitbucket"></span></a></li>
...
<div class="copyright py-3 text-center">
	<div class="container">
		<p class="my-2">© 2019. All rights reserved | Design by Adil El ghazzali
		</p>
	</div>
</div>
<!-- copyright -->
